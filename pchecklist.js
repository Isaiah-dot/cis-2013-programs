var $ = function (id)  // this is the function to connect the html to the java
{
    return document.getElementById(id);
};

var passwordCheckOld = function () // function to get the password from user and check with the program
{
    var stringPassword, arrayBadPasswords, stringOutput; // calling the variables
    
    stringPassword = $("password").value; // gets the users entered password
    
    // below is the array of bad passowrds
...
window.onload = function () // this function prints out the inputs when the button are clicked
{
//    $("password").value = "";
   $("output").value = "";       // gets the output value
   $("password").focus();
